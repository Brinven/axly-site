// Vendored: qrcode-generator v2.0.4 (ESM build, dist/qrcode.mjs) — Kazuhiko Arase, MIT.
// Source: https://www.npmjs.com/package/qrcode-generator  •  zero runtime deps.
// Vendored into public/ because Epona has no bundler (served static). Do not edit below.
// Same QR library the Axly fleet uses (Melpomene M7). Usage: qrcode(0,"M").addData(url).make().createDataURL(c,m)
//---------------------------------------------------------------------
//
